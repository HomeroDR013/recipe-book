      ...
      <div className="relative">
        ...
        <div className="absolute top-2 right-2 flex gap-1.5">
          <button
            ...
            className="bg-white/80 rounded-full p-1.5 hover:bg-white transition-colors leading-none"
          ...
          <button
            ...
            className="bg-white/80 rounded-full p-1.5 hover:bg-white transition-colors text-lg leading-none"
